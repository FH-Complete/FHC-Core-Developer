...
class Examples extends Auth_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('extensions/FHC-Core-Developer/Examplestatus_model', 'ExamplestatusModel');
	}
	...
	{
		$this->load->view('extensions/FHC-Core-Developer/Examples/BaseLayout');
	}

	public function tabulatorOnly()
	{
		$this->load->view('extensions/FHC-Core-Developer/Examples/TabulatorOnly');
	}
	...
	public function vuejs($example = null)
	{
		...
		$this->load->view('extensions/FHC-Core-Developer/Examples/VueJs' . $example);
	}
