...
class Form extends FHCAPI_Controller
{
	...
	/**
	 * Post Example
	 * @see FHC-Core-Developer/public/js/apps/examples/Form/Form.js
	 * @return void
	 */
	...
	/**
	 * Modal
	 * @see FHC-Core-Developer/public/js/apps/examples/Form/Modal.js
	 * @return void
	 */
	...
	/**
	 * Full Example
	 * @see FHC-Core-Developer/public/js/apps/examples/Form/Full.js
	 * @return void
	 */
