...
export default {
	...
	methods: {
		...
		async deleteData(exampledata_id) {
			...
			CoreRESTClient
				.post('/extensions/FHC-Core-Developer/Examples/deleteExampledata', {
		...
		acceptData() {
			...
			for (const exampledata_id of exampledata_ids) {
				...
				CoreRESTClient
					.post('/extensions/FHC-Core-Developer/Examples/updateExamplestatus', {
						exampledata_id: exampledata_id,
		...
		getExamplestatusList() {
			return CoreRESTClient
				.get('/extensions/FHC-Core-Developer/Examples/getExamplestatusList')
	...
	computed: {
		tabulatorOptions() {
			return {
				// Data source
				ajaxURL: CoreRESTClient._generateRouterURI('/extensions/FHC-Core-Developer/Examples/getExampledata'),
					...
					},
					{
						...
						formatterParams: cell => {
							return {
								...
								url: CoreRESTClient._generateRouterURI('extensions/FHC-Core-Developer/Examples/download/' + cell.getData().dms_id),
								target:"_blank"
							}
						}
					},
