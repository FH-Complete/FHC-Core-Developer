...
tabulatorOptions() {
	return {
		...
		ajaxURL: CoreRESTClient._generateRouterURI('/extensions/FHC-Core-Developer/FhcTemplate/getMyData'),
		...
		columns: [
		  ...
		  <span class="text-muted">// File download</span>
		  {
			...
			return {
				...
				url: CoreRESTClient._generateRouterURI('extensions/FHC-Core-Developer/MyController/download/' + cell.getData().dms_id),
				target:"_blank"
				}
			}
		  },
