...
export default {
					...
					},
					{
						...
						formatterParams: cell => {
							return {
								...
								url: CoreRESTClient._generateRouterURI('extensions/FHC-Core-Developer/MyExtension/download/' + cell.getData().dms_id),
								target:"_blank"
							}
						}
					},
	...
	methods: {
		...
		async deleteData(exampledata_id) {
			...
			CoreRESTClient
				.post('/extensions/FHC-Core-Developer/MyExtension/deleteExampledata', {
		...
		acceptData() {
			...
			for (const exampledata_id of exampledata_ids) {
				...
				CoreRESTClient
					.post('/extensions/FHC-Core-Developer/MyExtension/updateExamplestatus', {
						exampledata_id: exampledata_id,
		...
		getExamplestatusList() {
			return CoreRESTClient
				.get('/extensions/FHC-Core-Developer/MyExtension/getExamplestatusList')
