...
const app = Vue.createApp({
	...
	computed: {
		tabulatorOptions() {
			return {
				// Data source
				ajaxURL: CoreRESTClient._generateRouterURI('/extensions/FHC-Core-Developer/FhcTemplate/getTestData'),
					...
					},
					{
						...
						formatterParams: cell => {
							return {
								...
								url: CoreRESTClient._generateRouterURI('extensions/FHC-Core-Developer/FhcTemplate/download/' + cell.getData().datei.dms_id),
								target:"_blank"
							}
						},
