<?php
	$includesArray = [
		...
		'customJSModules' => [
			...
			'public/extensions/FHC-Core-Developer/js/apps/examples/Alerts/Basic.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Alerts/Example1.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Alerts/Example2.js'
		]
	];
			...
			<main class="col-lg-9">
				...
				<div class="d-flex justify-content-between">
					...
					<a
						href="#"
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Alerts/Example1.js"
						data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true" 
						data-bs-custom-class="filelist"
				...
				<pre class="border"><code class="language-js"><?= htmlentities(
					...
					'getActualDate() {' . "\n" .
					'	CoreRESTClient' . "\n" .
					'		.get(\'/extensions/FHC-Core-Developer/Examples/getActualDate\')' . "\n" .
				...
				<div class="d-flex justify-content-between">
					...
					<a
						href="#"
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Alerts/Example2.js"
						data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true" 
						data-bs-custom-class="filelist"
				...
				<pre class="border"><code class="language-js"><?= htmlentities(
					...
					'	CoreRESTClient' . "\n" .
					'		.post(\'/extensions/FHC-Core-Developer/Examples/deleteData/\' + id)' . "\n" .
					'		// Alert on success' . "\n" .
					'		.then(result => {' . "\n" .
					...
					'		.then(confirmed => confirmed ? \'/extensions/FHC-Core-Developer/Examples/deleteData/\' + id : new Promise(() => {}))' . "\n" .
					'		// Confirmed! You can go on...' . "\n" .
