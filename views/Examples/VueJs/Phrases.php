<?php
	$includesArray = [
		...
		'customJSModules' => [
			...
			'public/extensions/FHC-Core-Developer/js/apps/examples/Phrases/Emit.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Phrases/Dynamic.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Phrases/Preload.js'
		]
	];
	...
	<div id="main" data-bs-spy="scroll" data-bs-target="#sidenav">
		...
		<div id="content" class="row flex-row-reverse">
			...
			<main class="col-lg-9">
				...
				<p class="lead">/public/js/plugins/Phrasen.js</p>
				<p>
				...
				<div class="d-flex justify-content-between">
					...
					<a
						...
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Phrases/Emit.js, FHC-Core-Developer/public/js/components/examples/Phrases/Emit/Emitting.js, FHC-Core-Developer/public/js/components/examples/Phrases/Emit/Receiving.js"
				...
				<div class="d-flex justify-content-between">
					...
					<a
						href="#"
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Phrases/Dynamic.js"
						data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true"
						data-bs-custom-class="filelist"
				...
				<div class="d-flex justify-content-between">
					...
					<a
						href="#"
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Phrases/Preload.js"
						data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true"
						data-bs-custom-class="filelist"
