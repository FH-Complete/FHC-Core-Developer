<?php
	$includesArray = [
		...
		'customJSModules' => [
			...
			'public/extensions/FHC-Core-Developer/js/apps/examples/Tables/Basic.js'
		]
	];
		...
		<div id="content" class="row flex-row-reverse">
			...
			<main class="col-lg-9">
				...
				<div class="d-flex justify-content-between">
					<h6>Example:</h6>
					<a href="#" title="FHC-Core-Developer/public/js/apps/examples/Tables/Basic.js" data-bs-toggle="tooltip" data-bs-placement="left">
				...
				<pre class="border"><code class="language-js"><?= htmlentities(
					...
					'		setInitTableData() {' . "\n" .
					'			CoreRESTClient' . "\n" .
					'				.get(\'/extensions/FHC-Core-Developer/FhcTemplate/getTestData\')' . "\n" .
