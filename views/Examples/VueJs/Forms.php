<?php
	$includesArray = [
		...
		'customJSModules' => [
			...
			'public/extensions/FHC-Core-Developer/js/apps/examples/Form/Input.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Form/Validation.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Form/Form.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Form/Modal.js',
			'public/extensions/FHC-Core-Developer/js/apps/examples/Form/Full.js'
		]
	];
			...
			<main class="col-lg-9">
				...
				<div class="d-flex justify-content-between">
					...
					<a
						...
						data-bs-files="FHC-Core-Developer
				...
				<div class="d-flex justify-content-between">
					...
					<a
						href="#"
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer/public/js/apps/examples/Form/Validation.js"
				...
				<div class="d-flex justify-content-between">
					...
					<a
						...
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer
						public/js/apps/examples/Form/Form.js, FHC-Core-Developer/controllers/components/Form.php::postExample()" data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true"
						data-bs-custom-class="filelist"
						>
				...
				<p>
					The Form component also exposes a <code>factory</code> object. 
					This is the same as in the 
					<a href="<?= site_url("extensions/FHC-Core-Developer/examples/vuejs/fhcapi#plugin-factory"); ?>">FhcApi plugin</a> 
					but with the form injected for automatic validation handling.
				</p>
				...
				<div class="d-flex justify-content-between">
					...
					<a
						...
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer
						public/js/apps/examples/Form/Modal.js, FHC-Core-Developer/controllers/components/Form.php::modal()" data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true"
						data-bs-custom-class="filelist"
						>
				...
				<div class="d-flex justify-content-between">
					...
					<a
						...
						onclick="event.preventDefault()"
						data-bs-files="FHC-Core-Developer
						public/js/apps/examples/Form/Full.js, FHC-Core-Developer/controllers/components/Form.php::full()" data-bs-toggle="tooltip"
						data-bs-placement="left"
						data-bs-html="true"
						data-bs-custom-class="filelist"
						>
