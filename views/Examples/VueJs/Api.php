<?php
	$includesArray = [
		'title' => 'My Extension - VueJs Examples - Api',
		'vue3' => true,
		'axios027' => true,
		'bootstrap5' => true,
		'fontawesome6' => true,
		...
		<div id="content" class="row flex-row-reverse">
			...
			<aside class="col-lg-3">
				<div id="sidenav" class="list-group sticky-lg-top">
					...
					<a href="#plugin-enable" class="list-group-item list-group-item-action">
						<span class="ps-3">
							Enable Api Core Plugin in your App
						</span>
					</a>
					...
					<a href="#plugin-usage-call" class="list-group-item list-group-item-action">
						<span class="ps-3"><span class="ps-3">
					...
					<a href="#plugin-factory-endpoints" class="list-group-item list-group-item-action">
						<span class="ps-3"><span class="ps-3">
							Providing endpoints
						</span></span>
					</a>
					<a href="#plugin-factory-syntax" class="list-group-item list-group-item-action">
						<span class="ps-3"><span class="ps-3">
							Endpoint syntax
						</span></span>
					</a>
					<a href="#plugin-factory-example" class="list-group-item list-group-item-action">
						<span class="ps-3"><span class="ps-3">
							Endpoint example
						</span></span>
					</a>
			...
			<main class="col-lg-9">
				...
				<ul class="list-group mb-3">
					...
					<li id="plugin-usage-call" class="list-group-item list-group-item-primary">
						call
					</li>
					<li class="list-group-item">
						Call a factory endpoint.<br><br>
						Returns: an axios <code>Promise</code>
					</li>
					<li class="list-group-item">
						<samp class="d-block">call(endpoint)</samp>
						<samp class="d-block">call(endpoint, config)</samp>
						<samp class="d-block">call(endpoint, config, form)</samp>
					</li>
					<li class="list-group-item">
						<table class="table table-sm">
							<thead class="">
							...
							<tbody>
								<tr>
									...
									<td>object</td>
									<td>The result of a factory function.</td>
								</tr>
								<tr>
									<td><code>config</code></td>
									<td>object</td>
									<td>Additional config for the axios request. Additional options see below.</td>
								</tr>
								<tr>
				...
				<p>
					...
					The core factory functions are located in <code>/public/js/api/</code>.
				</p>
				<h4 class="h5" id="plugin-factory-endpoints">Providing endpoints</h4>
				<p>
				...
				<p>
					The endpoint functions should return an <code>object</code> as described below.
				</p>
				<ul class="list-group mb-3">
					<li id="plugin-factory-syntax" class="list-group-item list-group-item-primary">
						Endpoint syntax
					</li>
					<li class="list-group-item">
						<table class="table table-sm">
							...
							<tbody>
								<tr>
									...
									<td>string</td>
									<td>
										'get' or 'post' for a GET or POST request respectively.
									</td>
								</tr>
								<tr>
									<td><code>url</code></td>
									...
									<td>string</td>
									<td>
										The Uri (part after index.ci.php) of the endpoint.
									</td>
								</tr>
								<tr>
									<td><code>params</code></td>
									...
									<td>object</td>
									<td>
										The GET parameters or the POST data (depending on the given method).
									</td>
								</tr>
							</tbody>
						</table>
				...
				<h5 class="h6 mt-3" id="plugin-factory-example">Endpoint example:</h5>
				<pre class="border"><code class="language-js"><?= htmlentities(
					...
					"\n" .
					'// usage:' . "\n" .
					'import ApiExamples from \'/public/js/api/examples.js\';' . "\n" .
					"\n" .
					'this.$api.call(ApiExamples.doSmth());'
				); ?></code></pre>
